...
export const UTTARAKHAND_PACKAGES = [
    ...
    // Chopta (Mini Switzerland)
    {
        ...
        gallery: [
            'https://images.unsplash.com/photo-1588147363102-1f5be5f79573?w=800&q=80',
        ],
    ...
    // Binsar Package
    {
        ...
        reviews: 114,
        tag: 'WILDLIFE',
        img: 'https://images.unsplash.com/photo-1622340331005-728b7e2e307e?w=800&q=80',
        gallery: [
            'https://images.unsplash.com/photo-1622340331005-728b7e2e307e?w=800&q=80',
        ],
...
export const ACTIVITIES = [
    {
        ...
        desc: 'Grade III???V rapids on the holy Ganga through scenic gorges',
    },
    {
        name: 'Camping',
